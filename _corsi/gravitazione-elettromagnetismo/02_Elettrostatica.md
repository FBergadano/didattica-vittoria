...
<p class="iex-qt">Un atomo con carica $-3\, e$ possiede 14 protoni. Quanti elettroni possiede?</p>
<div class="iex-choices" id="iexAtomichoices3">
<button class="iex-choice-btn" data-v="a">17</button>
<button class="iex-choice-btn" data-v="b">11</button>
<button class="iex-choice-btn" data-v="c">14</button>
<button class="iex-choice-btn" data-v="d">Dipende dall'elemento chimico</button>
</div>
<div class="iex-fb" id="iexAtomifb4"></div>
</div>

<div class="iex-q" id="iexAtomirow5" style="display:none">
...
<div class="iex-fb" id="iexAtomifb5"></div>
</div>
...
<div class="dirf-widget">
<svg viewBox="0 0 700 210" style="max-width:640px;width:100%;height:auto;display:block;margin:0 auto;" role="img" aria-label="Direzione e verso della forza elettrica: due cariche positive si respingono, due cariche negative si respingono, due cariche opposte si attraggono">
<defs>
  <radialGradient id="dirPosG" cx="35%" cy="30%" r="75%"><stop offset="0%" stop-color="#fff1f2"/><stop offset="55%" stop-color="#fecdd3"/><stop offset="100%" stop-color="#fda4af"/></radialGradient>
  <radialGradient id="dirNegG" cx="35%" cy="30%" r="75%"><stop offset="0%" stop-color="#eff6ff"/><stop offset="55%" stop-color="#bfdbfe"/><stop offset="100%" stop-color="#93c5fd"/></radialGradient>
  <marker id="dirArrow" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="7" markerHeight="7" orient="auto-start-reverse">
    <path d="M0,0 L10,5 L0,10 z" fill="#0f766e"/>
  </marker>
</defs>

<!-- Pannello 1: due cariche positive, repulsione -->
<line x1="32" y1="90" x2="208" y2="90" stroke="#c4c9d1" stroke-width="1.3" stroke-dasharray="3 4"/>
<line x1="78" y1="90" x2="30" y2="90" stroke="#0f766e" stroke-width="3" marker-end="url(#dirArrow)"/>
<line x1="162" y1="90" x2="210" y2="90" stroke="#0f766e" stroke-width="3" marker-end="url(#dirArrow)"/>
<circle cx="78" cy="90" r="22" fill="url(#dirPosG)" stroke="#9f1239" stroke-width="1.3"/>
<text x="78" y="96" text-anchor="middle" font-size="20" font-weight="700" fill="#9f1239">+</text>
<circle cx="162" cy="90" r="22" fill="url(#dirPosG)" stroke="#9f1239" stroke-width="1.3"/>
<text x="162" y="96" text-anchor="middle" font-size="20" font-weight="700" fill="#9f1239">+</text>
<text x="18" y="82" text-anchor="middle" font-size="13" fill="#0f766e" font-style="italic">F</text>
<text x="222" y="82" text-anchor="middle" font-size="13" fill="#0f766e" font-style="italic">F</text>
<text x="120" y="150" text-anchor="middle" font-size="14" fill="#374151" font-weight="600">Cariche dello stesso segno</text>
<text x="120" y="170" text-anchor="middle" font-size="13" fill="#0f766e" font-style="italic">si respingono</text>

<!-- Pannello 2: due cariche negative, repulsione -->
<line x1="262" y1="90" x2="438" y2="90" stroke="#c4c9d1" stroke-width="1.3" stroke-dasharray="3 4"/>
<line x1="308" y1="90" x2="260" y2="90" stroke="#0f766e" stroke-width="3" marker-end="url(#dirArrow)"/>
<line x1="392" y1="90" x2="440" y2="90" stroke="#0f766e" stroke-width="3" marker-end="url(#dirArrow)"/>
<circle cx="308" cy="90" r="22" fill="url(#dirNegG)" stroke="#1e3a8a" stroke-width="1.3"/>
<text x="308" y="96" text-anchor="middle" font-size="20" font-weight="700" fill="#1e3a8a">–</text>
<circle cx="392" cy="90" r="22" fill="url(#dirNegG)" stroke="#1e3a8a" stroke-width="1.3"/>
<text x="392" y="96" text-anchor="middle" font-size="20" font-weight="700" fill="#1e3a8a">–</text>
<text x="248" y="82" text-anchor="middle" font-size="13" fill="#0f766e" font-style="italic">F</text>
<text x="452" y="82" text-anchor="middle" font-size="13" fill="#0f766e" font-style="italic">F</text>
<text x="350" y="150" text-anchor="middle" font-size="14" fill="#374151" font-weight="600">Cariche dello stesso segno</text>
<text x="350" y="170" text-anchor="middle" font-size="13" fill="#0f766e" font-style="italic">si respingono</text>

<!-- Pannello 3: cariche opposte, attrazione -->
<line x1="538" y1="90" x2="622" y2="90" stroke="#c4c9d1" stroke-width="1.3" stroke-dasharray="3 4"/>
<line x1="538" y1="90" x2="568" y2="90" stroke="#b45309" stroke-width="3" marker-end="url(#dirArrow)"/>
<line x1="622" y1="90" x2="592" y2="90" stroke="#b45309" stroke-width="3" marker-end="url(#dirArrow)"/>
<circle cx="538" cy="90" r="22" fill="url(#dirPosG)" stroke="#9f1239" stroke-width="1.3"/>
<text x="538" y="96" text-anchor="middle" font-size="20" font-weight="700" fill="#9f1239">+</text>
<circle cx="622" cy="90" r="22" fill="url(#dirNegG)" stroke="#1e3a8a" stroke-width="1.3"/>
<text x="622" y="96" text-anchor="middle" font-size="20" font-weight="700" fill="#1e3a8a">–</text>
<text x="553" y="78" text-anchor="middle" font-size="13" fill="#b45309" font-style="italic">F</text>
<text x="607" y="78" text-anchor="middle" font-size="13" fill="#b45309" font-style="italic">F</text>
<text x="580" y="150" text-anchor="middle" font-size="14" fill="#374151" font-weight="600">Cariche di segno opposto</text>
<text x="580" y="170" text-anchor="middle" font-size="13" fill="#b45309" font-style="italic">si attraggono</text>
</svg>
<p class="dirf-caption">In tutti e tre i casi il vettore forza giace sulla retta che congiunge i centri delle due cariche (linea tratteggiata): la forza elettrica è una <strong>forza centrale</strong>.</p>
</div>

<style>
.dirf-widget { margin: 1.6rem auto; text-align: center; }
.dirf-caption { font-size: .85rem; color: #6b7280; font-style: italic; margin-top: .6rem; max-width: 600px; margin-left: auto; margin-right: auto; }
@media print { .dirf-widget { display: none; } }
</style>
...
<div id="coulx1" class="coulx-widget">
  ...
  <div class="coulx-scenario-tabs">
    <button class="coulx-tab active" data-scenario="charge">Dipendenza dalle cariche</button>
    <button class="coulx-tab" data-scenario="r">Dipendenza da r</button>
  </div>
  <div class="coulx-stage">
    <div class="coulx-canvas-wrap">
  ...
  <div class="coulx-legend">
    <div class="coulx-legend-item"><span class="coulx-legend-dot" style="background:#e8983a"></span> Sfera carica positiva</div>
    <div class="coulx-legend-item"><span class="coulx-legend-dot" style="background:#6fa8ff"></span> Sfera carica negativa</div>
    <div class="coulx-legend-item"><span class="coulx-legend-dot" style="background:#d8d8d8"></span> Piattino indicatore</div>
  </div>
...
.coulx-widget {
  ...
  --clx-surface: #10141c;
  --clx-copper: #b87333;
  --clx-copper-bright: #e8983a;
  --clx-amber: #ff9a00;
  --clx-glow: rgba(184,115,51,0.4);
  --clx-text: #e8d5b0;
  --clx-text2: #9a8060;
  --clx-rline: #6fd3d9;
  font-family: 'Crimson Text', Georgia, serif;
...
.coulx-tab {
  ...
  background:transparent; border:1px solid rgba(184,115,51,.4); color: var(--clx-text2);
...
.coulx-choice:hover { border-color: var(--clx-copper); color: var(--clx-copper-bright); }
.coulx-choice.active { background: var(--clx-copper); border-color: var(--clx-copper); color: var(--clx-bg); font-weight:700; }

.coulx-centre-controls { display:flex; flex-direction:column; align-items:center; gap:.55rem; }
.coulx-btn-main, .coulx-btn-rev, .coulx-rbtn {
...
.coulx-btn-main {
  background:transparent; border:1.4px solid var(--clx-copper); color: var(--clx-copper-bright);
}
.coulx-btn-main:hover { background: rgba(184,115,51,.18); }
.coulx-btn-main.active { background: var(--clx-copper); color: var(--clx-bg); }
.coulx-btn-rev, .coulx-rbtn {
  background:transparent; border:1px solid rgba(184,115,51,.4); color: var(--clx-text2);
}
...
<script>
(function(){
  var root = document.getElementById('coulx1');
  if (!root) return;
  function $(s){ return root.querySelector(s); }

  var K_COUL = 8.99e9;
  var NC = 1e-9; // le cariche sono espresse in nanocoulomb (nC)

  // Raggi delle sfere: fissi, non cambiano scegliendo un valore di carica diverso.
  var RM_VIS = 0.020;
  var Rm_VIS = 0.010;
  ...
  // La carica fissa tocca la parete dal lato opposto.
  var BASE_R = 0.17, BASE_H = 0.02;
  var GLASS_R = 0.17, GLASS_H = 0.32;
  var LID_R = 0.17, LID_H = 0.02;
  var TUBE_R = 0.022, TUBE_H = 0.06;
  var KNOB_R = 0.026;
  var LR = GLASS_R - Rm_VIS;   // raggio dell'orbita della carica mobile sul bilancere
  var D_M = GLASS_R - RM_VIS;  // la carica fissa tocca la parete di vetro
  var ROD_Y = BASE_H + GLASS_H * 0.42;
  var RING_R = GLASS_R;
  var THETA_M = Math.PI; // la carica fissa sta a sinistra

  var THETA_INITIAL = THETA_M - 90 * Math.PI / 180; // condizione iniziale: 90° da Q

  // A differenza della gravità (sempre attrattiva), due cariche possono
  // respingersi (stesso segno) o attrarsi (segno opposto). Se si respingono,
  // il bilancere ruota allontanandosi da Q: non c'è rischio che le sfere si
  // tocchino, e un margine di sicurezza ANGLE_FAR molto ampio serve solo a
  // evitare eventuali derive numeriche. Se invece si attraggono, il
  ...
  // attrarsi è un equilibrio "instabile" (avvicinarsi aumenta la forza, che
  // avvicina ancora di più), quindi serve un filo molto più rigido perché il
  // bilancere si fermi prima del fermo meccanico, invece di sbatterci contro.
  var K_WIRE_REPULSIVE = 1.22e-6;
  // L'attrazione ha infatti un limite di stabilità intrinseco: oltre un certo
  // angolo l'equilibrio non esiste più per NESSUNA rigidità del filo, e il
  // bilancere collassa inevitabilmente verso il contatto (a differenza della
  // repulsione, che è invece sempre stabile). Quel limite però dipende quasi
  // solo dalla geometria e pochissimo dalla carica: usare, combinazione per
  // combinazione, il filo più morbido possibile senza collassare finirebbe
  // per fermarle tutte quasi allo stesso angolo, nascondendo proprio ciò che
  // vogliamo mostrare — che una carica maggiore produce una forza (e quindi
  // una rotazione) maggiore. Usiamo perciò un'unica rigidità, come per la
  // repulsione, scelta abbastanza morbida da rendere ben visibile la
  // crescita fra le quattro combinazioni ma abbastanza rigida da lasciare un
  // margine di sicurezza comodo anche per la coppia di cariche più forte.
  var K_WIRE_ATTRACTIVE = 1.8e-5;
  var STEP = 8000, CONV_EPS = 1e-5;
  ...
  var state = { Q: 20, q: 2, Qsign: 1, qsign: 1, angle: THETA_INITIAL, mode: 'manual' };
  var scenario = 'charge';

  function signedQ() { return state.Q * state.Qsign * NC; }
  function signedq() { return state.q * state.qsign * NC; }
  function isRepulsive() { return state.Qsign * state.qsign > 0; }

  var fValEl = $('.coulx-fval');
  var playBtn = $('.coulx-play'), resetBtn = $('.coulx-reset');
  var QBtns = root.querySelectorAll('.coulx-Qbtn');
  var qBtns = root.querySelectorAll('.coulx-qbtn');
  var QSignBtns = root.querySelectorAll('.coulx-Qsign');
  var qSignBtns = root.querySelectorAll('.coulx-qsign');
  var tabs = root.querySelectorAll('.coulx-tab');
  var panelMass = $('.coulx-panel-charge'), panelR = $('.coulx-panel-r');
  var rBtnsContainer = $('.coulx-rstudy-btns');
  var rCurEl = $('.coulx-r-cur'), rFBeforeEl = $('.coulx-r-fbefore'), rRatioEl = $('.coulx-rstudy-ratio');

  var appCv = $('.coulx-app'), appCtx = appCv.getContext('2d');
  ...
  // Il modulo della forza (mostrato allo studente) non dipende dal segno.
  function force() {
    var r = rDist(state.angle);
    return Math.abs(K_COUL * signedQ() * signedq() / (r * r));
  }
  // Il momento torcente usa invece la forza CON SEGNO: se le cariche sono
  // dello stesso segno (prodotto positivo) il termine è repulsivo e il
  // bilancere si allontana da Q; se sono di segno opposto (prodotto negativo)
  // lo stesso termine cambia automaticamente verso, e il bilancere si
  // avvicina a Q — esattamente come nel caso, sempre attrattivo, della gravità.
  function torqueElectric(angle) {
    var rr = rDist(angle);
    var fs = K_COUL * signedQ() * signedq() / (rr * rr);
    return fs * LR * D_M * Math.sin(angle - THETA_M) / rr;
  }
  function fmtSci(x) {
    if (x === 0) return '0';
  ...
  // Colore della sferetta a seconda del segno della carica: ambra per il
  // positivo, blu per il negativo (stessa convenzione usata nel resto del capitolo).
  function sphereColors(sign) {
    return sign > 0 ? ['#ffdca0', '#a9701e'] : ['#bfdbfe', '#1e3a8a'];
  }
  ...
  function drawApparatus() {
    ...
    // filo di supporto della carica fissa: dal perno sul tappo giù fino a Q
    ...
    // bilancere: carica mobile q su un lato, piattino verticale sull'altro
    ...
    var qCol = sphereColors(state.qsign), QCol = sphereColors(state.Qsign);
    sphereAt(appCtx, pm, Rm_VIS, qCol[0], qCol[1]);
    sphereAt(appCtx, pMFix, RM_VIS, QCol[0], QCol[1]);

    appCtx.font = '700 15px Georgia, serif';
    appCtx.textAlign = 'center';
    appCtx.textBaseline = 'middle';
    appCtx.fillStyle = state.qsign > 0 ? '#7a2f0a' : '#0f2050';
    appCtx.fillText(state.qsign > 0 ? '+' : '–', pm.sx, pm.sy);
    appCtx.fillStyle = state.Qsign > 0 ? '#7a2f0a' : '#0f2050';
    appCtx.fillText(state.Qsign > 0 ? '+' : '–', pMFix.sx, pMFix.sy);
    appCtx.textBaseline = 'alphabetic';

    appCtx.font = 'italic 16px Georgia, serif';
    appCtx.fillStyle = '#c7ccd4';
    appCtx.fillText('q', pm.sx, pm.sy - Rm_VIS * PXM * pm.scale - 10);
    appCtx.fillStyle = '#e8983a';
    appCtx.fillText('Q', pMFix.sx, pMFix.sy - RM_VIS * PXM * pMFix.scale - 12);
    ...
    // perno sul tappo, dove è fissato il filo della carica fissa (visibile dall'alto)
  ...
  function loop() {
    if (state.mode === 'dynamic') {
      var kWire = isRepulsive() ? K_WIRE_REPULSIVE : K_WIRE_ATTRACTIVE;
      var net = torqueElectric(state.angle) - kWire * (state.angle - THETA_INITIAL);
      var delta = net * STEP;
      var newAngle = state.angle + delta;
      if (newAngle >= ANGLE_NEAR) {
        // fermo meccanico: cariche opposte si attraggono, il bilancere non
        // può avvicinarsi oltre, per non far toccare le sfere.
        state.angle = ANGLE_NEAR;
        state.mode = 'manual';
        playBtn.textContent = '▶ Avvia';
        playBtn.classList.remove('active');
      } else if (newAngle <= ANGLE_FAR) {
        // margine di sicurezza (mai raggiunto in pratica): il bilancere non
        // supera mai una rotazione così ampia prima di trovare l'equilibrio.
        state.angle = ANGLE_FAR;
        state.mode = 'manual';
        playBtn.textContent = '▶ Avvia';
        playBtn.classList.remove('active');
  ...
  QBtns.forEach(function (b) {
    b.addEventListener('click', function () { selectChoice(QBtns, +b.dataset.val, 'Q'); });
  });
  qBtns.forEach(function (b) {
    b.addEventListener('click', function () { selectChoice(qBtns, +b.dataset.val, 'q'); });
  });

  function selectSign(btns, val, prop) {
    btns.forEach(function (b) { b.classList.toggle('active', +b.dataset.sign === val); });
    state[prop] = val;
  }
  QSignBtns.forEach(function (b) {
    b.addEventListener('click', function () { selectSign(QSignBtns, +b.dataset.sign, 'Qsign'); });
  });
  qSignBtns.forEach(function (b) {
    b.addEventListener('click', function () { selectSign(qSignBtns, +b.dataset.sign, 'qsign'); });
  });
...
<div class="iex-widget" id="invCarCoulomb">
...
<div class="iex-topnav">
<button class="iex-navbtn" id="invCarCoulombprev" onclick="invCarCoulombnav(-1)" disabled>&larr; Prec.</button>
<div class="iex-dots" id="invCarCoulombdots"></div>
<button class="iex-navbtn" id="invCarCoulombnext" onclick="invCarCoulombnav(1)">Succ. &rarr;</button>
</div>

<div class="iex-q" id="invCarCoulombrow0">
<div class="iex-nested">
{% include invert.html id="inv-coulomb-k" variabili="F|k|Qa|Qb|r" etichette="F|k|q_1|q_2|r"
   sinistra="F" destra="k*Qa*Qb/r/r" obiettivo="k" %}
</div>
</div>

<div class="iex-q" id="invCarCoulombrow1" style="display:none">
<div class="iex-nested">
{% include invert.html id="inv-coulomb-Qa" variabili="F|k|Qa|Qb|r" etichette="F|k|q_1|q_2|r"
   sinistra="F" destra="k*Qa*Qb/r/r" obiettivo="Qa" %}
</div>
</div>

<div class="iex-q" id="invCarCoulombrow2" style="display:none">
<div class="iex-nested">
{% include invert.html id="inv-coulomb-Qb" variabili="F|k|Qa|Qb|r" etichette="F|k|q_1|q_2|r"
   sinistra="F" destra="k*Qa*Qb/r/r" obiettivo="Qb" %}
</div>
</div>

<div class="iex-q" id="invCarCoulombrow3" style="display:none">
<div class="iex-nested">
{% include invert.html id="inv-coulomb-r" variabili="F|k|Qa|Qb|r" etichette="F|k|q_1|q_2|r"
   sinistra="F" destra="k*Qa*Qb/r/r" obiettivo="r" radice="1" %}
</div>
</div>
...
setupInvCarousel('invCarCoulomb',4);
</script>
...
<div class="iex-widget" id="iexConfronto">
<p class="iex-lbl">Verifica Subito!</p>
<div class="iex-topnav">
<button class="iex-navbtn" id="iexConfrontoprev" onclick="iexConfrontonav(-1)" disabled>&larr; Prec.</button>
<div class="iex-dots" id="iexConfrontodots"></div>
<button class="iex-navbtn" id="iexConfrontonext" onclick="iexConfrontonav(1)">Succ. &rarr;</button>
</div>

<div class="iex-q" id="iexConfrontorow0">
<p class="iex-qt">Perché nella formula della forza elettrica compare il valore assoluto, $F = k\,\dfrac{\lvert q_1\cdot q_2\rvert}{r^2}$, mentre in quella della forza gravitazionale, $F = G\,\dfrac{m_1\cdot m_2}{r^2}$, no?</p>
<div class="iex-choices" id="iexConfrontochoices0">
<button class="iex-choice-btn" data-v="a">Perché la forza elettrica è sempre più intensa di quella gravitazionale</button>
<button class="iex-choice-btn" data-v="b">Perché le masse sono sempre positive, mentre le cariche possono essere sia positive sia negative: senza il valore assoluto il prodotto $q_1\cdot q_2$ potrebbe risultare negativo, cosa impossibile per un modulo</button>
<button class="iex-choice-btn" data-v="c">Perché $k$ è una costante più grande di $G$</button>
<button class="iex-choice-btn" data-v="d">È solo una convenzione, senza un vero motivo fisico</button>
</div>
<div class="iex-fb" id="iexConfrontofb0"></div>
</div>

<div class="iex-q" id="iexConfrontorow1" style="display:none">
<p class="iex-qt">Quale fra le due costanti, $k$ (costante di Coulomb) e $G$ (costante di gravitazione universale), ha il valore più grande?</p>
<div class="iex-choices" id="iexConfrontochoices1">
<button class="iex-choice-btn" data-v="a">$G$ è più grande di $k$</button>
<button class="iex-choice-btn" data-v="b">Sono all'incirca uguali</button>
<button class="iex-choice-btn" data-v="c">$k$ è enormemente più grande di $G$: è proprio per questo che, a parità di distanza, la forza elettrica è molto più intensa di quella gravitazionale</button>
<button class="iex-choice-btn" data-v="d">Non si possono confrontare, perché una delle due è sempre negativa</button>
</div>
<div class="iex-fb" id="iexConfrontofb1"></div>
</div>

<div class="iex-q" id="iexConfrontorow2" style="display:none">
<p class="iex-qt">Quale fra la forza elettrica e la forza gravitazionale è una forza <strong>centrale</strong> (cioè diretta lungo la retta che congiunge i due corpi)?</p>
<div class="iex-choices" id="iexConfrontochoices2">
<button class="iex-choice-btn" data-v="a">Solo la forza gravitazionale</button>
<button class="iex-choice-btn" data-v="b">Solo la forza elettrica</button>
<button class="iex-choice-btn" data-v="c">Entrambe</button>
<button class="iex-choice-btn" data-v="d">Nessuna delle due</button>
</div>
<div class="iex-fb" id="iexConfrontofb2"></div>
</div>

<div class="iex-q" id="iexConfrontorow3" style="display:none">
<p class="iex-qt">La forza elettrica può essere sia attrattiva sia repulsiva, a seconda del segno delle cariche coinvolte. La forza gravitazionale, invece, può essere:</p>
<div class="iex-choices" id="iexConfrontochoices3">
<button class="iex-choice-btn" data-v="a">Sia attrattiva sia repulsiva, esattamente come quella elettrica</button>
<button class="iex-choice-btn" data-v="b">Solo repulsiva</button>
<button class="iex-choice-btn" data-v="c">Solo attrattiva, perché non esiste alcuna "massa negativa"</button>
<button class="iex-choice-btn" data-v="d">Né attrattiva né repulsiva: la gravità non è una forza vera e propria</button>
</div>
<div class="iex-fb" id="iexConfrontofb3"></div>
</div>

<div class="iex-q" id="iexConfrontorow4" style="display:none">
<p class="iex-qt">Sia la forza elettrica sia quella gravitazionale sono inversamente proporzionali a:</p>
<div class="iex-choices" id="iexConfrontochoices4">
<button class="iex-choice-btn" data-v="a">La distanza $r$</button>
<button class="iex-choice-btn" data-v="b">Il quadrato della distanza $r^2$</button>
<button class="iex-choice-btn" data-v="c">Il cubo della distanza $r^3$</button>
<button class="iex-choice-btn" data-v="d">Nessuna delle due dipende dalla distanza</button>
</div>
<div class="iex-fb" id="iexConfrontofb4"></div>
</div>

<div class="iex-q" id="iexConfrontorow5" style="display:none">
<p class="iex-qt">Che cosa hanno in comune la forza elettrica e la forza gravitazionale, riguardo al <em>modo</em> in cui agiscono a livello microscopico fra due corpi?</p>
<div class="iex-choices" id="iexConfrontochoices5">
<button class="iex-choice-btn" data-v="a">Agiscono solo se i due corpi sono a diretto contatto</button>
<button class="iex-choice-btn" data-v="b">Sono entrambe forze <strong>a distanza</strong>: agiscono anche se i corpi non si toccano, senza bisogno di alcun mezzo materiale che le trasmetta</button>
<button class="iex-choice-btn" data-v="c">Agiscono solo se i due corpi sono in movimento relativo</button>
<button class="iex-choice-btn" data-v="d">Serve sempre l'aria (o un altro gas) a trasmetterle, come per il suono</button>
</div>
<div class="iex-fb" id="iexConfrontofb5"></div>
</div>

</div>

<style>
@media print { #iexConfronto { display:none; } }
</style>

<script>
(function(){
  var N=6, cur=0, ok=[false,false,false,false,false,false];
  function updateDots(){
    var dots=document.querySelectorAll('#iexConfrontodots .iex-dot');
    for(var i=0;i<N;i++)dots[i].className='iex-dot'+(i===cur?' cur':'')+(ok[i]?' ok':'');
  }
  function show(i){
    document.querySelectorAll('#iexConfronto .iex-q').forEach(function(q){q.style.display='none';});
    document.getElementById('iexConfrontorow'+i).style.display='block';
    cur=i;
    document.getElementById('iexConfrontoprev').disabled=(i===0);
    document.getElementById('iexConfrontonext').disabled=(i===N-1);
    updateDots();
  }
  function buildDots(){
    var c=document.getElementById('iexConfrontodots');
    for(var j=0;j<N;j++){
      var d=document.createElement('span');
      d.className='iex-dot'+(j===0?' cur':'');
      d.title='Domanda '+(j+1);
  ...
  buildDots();
  window.iexConfrontonav=function(d){ if(cur+d>=0 && cur+d<N) show(cur+d); };
    ...
    btns.forEach(function(btn){
      btn.addEventListener('click', function(){
        ...
        if(correct){
          btn.className = 'iex-choice-btn correct';
          ok[rowIdx] = true; fb.className = 'iex-fb ok';
          fb.innerHTML = '&#10003; Esatto! '+msgOk+(rowIdx<N-1?' <button class="iex-nextbtn" onclick="iexConfrontonav(1)">Passo successivo &rarr;</button>':'');
          shootConf(btn); updateDots();
        } else {
          btn.className = 'iex-choice-btn wrong';
          var correctBtn = document.querySelector('#'+choicesId+' .iex-choice-btn[data-v="'+correctV+'"]');
  ...
  wireChoices(0, 'iexConfrontochoices0', 'iexConfrontofb0', 'b',
    'Le cariche, a differenza delle masse, possono essere negative: senza il valore assoluto la formula darebbe a volte una forza "negativa", che non ha senso per un modulo (che è sempre $\\geq 0$).',
    'Non è corretto: il motivo è che le cariche (a differenza delle masse) possono essere negative, quindi il prodotto $q_1\\cdot q_2$ potrebbe risultare negativo — impossibile per un modulo, che è sempre positivo.');

  wireChoices(1, 'iexConfrontochoices1', 'iexConfrontofb1', 'c',
    '$k = 8{,}99\\times10^9\\ \\text{N}\\cdot\\text{m}^2/\\text{C}^2$ contro $G=6{,}67\\times10^{-11}\\ \\text{N}\\cdot\\text{m}^2/\\text{kg}^2$: una differenza di ben 20 ordini di grandezza!',
    'Non è corretto: $k$ è enormemente più grande di $G$ (circa $10^{20}$ volte). È proprio per questo che la forza elettrica è così più intensa di quella gravitazionale, a parità di distanza e di "quantità" (carica o massa).');

  wireChoices(2, 'iexConfrontochoices2', 'iexConfrontofb2', 'c',
    'Sono entrambe forze centrali: il vettore forza giace sempre sulla retta che congiunge i due corpi (o le due cariche).',
    'Non è corretto: sono entrambe forze centrali — lo abbiamo visto sia per la forza gravitazionale sia, più di recente, per quella elettrica.');

  wireChoices(3, 'iexConfrontochoices3', 'iexConfrontofb3', 'c',
    'La massa è sempre positiva, quindi il prodotto $m_1\\cdot m_2$ è sempre positivo e la forza gravitazionale è sempre attrattiva: non esiste una "antigravità".',
    'Non è corretto: la forza gravitazionale può essere solo attrattiva, perché la massa è sempre positiva (non esiste una "massa negativa").');

  wireChoices(4, 'iexConfrontochoices4', 'iexConfrontofb4', 'b',
    'Sia $F=k\\lvert q_1 q_2\\rvert/r^2$ sia $F=Gm_1m_2/r^2$ dipendono dall\'inverso del quadrato della distanza.',
    'Non è corretto: entrambe le forze sono inversamente proporzionali al quadrato della distanza, $1/r^2$.');

  wireChoices(5, 'iexConfrontochoices5', 'iexConfrontofb5', 'b',
    'Sono entrambe forze "a distanza" (o "a campo"): agiscono anche fra corpi lontani e separati dal vuoto, senza che nulla li tocchi fisicamente.',
    'Non è corretto: sono entrambe forze a distanza, che agiscono anche senza contatto diretto e senza bisogno di un mezzo materiale.');
})();
</script>
...
<div class="sort-widget" id="sw-sortc1">
<p class="sort-hint">Trascina ogni voce nella colonna appropriata.</p>
<div class="sort-pool" id="sp-sortc1"></div>
<div class="sort-table sortc-table3">
<div class="sort-zone">
<div class="sort-zone-hdr">Solo forza gravitazionale</div>
<div class="sort-zone-body" id="szb-sortc1-0" data-cat="0"></div>
</div>
<div class="sort-zone">
<div class="sort-zone-hdr">Entrambe</div>
<div class="sort-zone-body" id="szb-sortc1-2" data-cat="2"></div>
</div>
<div class="sort-zone">
<div class="sort-zone-hdr">Solo forza elettrica</div>
<div class="sort-zone-body" id="szb-sortc1-1" data-cat="1"></div>
</div>
</div>
<div class="sort-ctrl">
<button class="sort-vbtn" id="sv-sortc1">✓ Verifica</button>
<button class="sort-rbtn" id="sr-sortc1">↺ Ricomincia</button>
</div>
<div class="sort-fb" id="sf-sortc1"></div>
</div>

<style>
.sortc-table3 { grid-template-columns: 1fr 1fr 1fr !important; }
@media (max-width: 640px) { .sortc-table3 { grid-template-columns: 1fr !important; } }
#sw-sortc1 .sort-item { display: inline-block; white-space: normal; text-align: center; }
</style>

<script>
(function(){
var D=[
  {"t":"È sempre attrattiva","c":0},
  {"t":"La sua costante ($G$) è piccolissima","c":0},
  {"t":"Non esiste una \"massa negativa\"","c":0},
  {"t":"Può essere anche repulsiva","c":1},
  {"t":"La sua costante ($k$) è enorme","c":1},
  {"t":"Nella formula compare un valore assoluto","c":1},
  {"t":"È una forza centrale","c":2},
  {"t":"È una forza a distanza","c":2},
  {"t":"È inversamente proporzionale a $r^2$","c":2},
  {"t":"È proporzionale al prodotto delle due grandezze coinvolte","c":2}
];
var ID='sortc1';
...
function mkItem(d){
  ...
  el.className='sort-item';el.innerHTML=d.t;
...
function render(){
  ...
  if (window.MathJax && MathJax.typesetPromise) MathJax.typesetPromise([pool]);
}
...
document.getElementById('sv-'+ID).addEventListener('click',function(){
  ...
  if(allOk){
    fb.className='sort-fb ok';fb.textContent='✓ Perfetto! Tutte le caratteristiche sono nella colonna giusta.';
    _shoot(btn);
    ...
    fb.className='sort-fb err';fb.textContent='✗ Alcune caratteristiche non sono nella colonna giusta. Quelle corrette sono in verde, le altre in rosso.';
  }
});
...
<div class="fig-block">
<svg viewBox="0 0 360 280" width="100%" style="max-width:320px;height:auto;display:block;margin:0 auto;" role="img" aria-label="Animazione: le due forze elettriche repulsive e la loro somma vettoriale">
  <defs>
    <radialGradient id="pcQ1" cx="35%" cy="30%" r="70%">
      <stop offset="0%" stop-color="#fff1f2"/><stop offset="55%" stop-color="#fecdd3"/><stop offset="100%" stop-color="#fda4af"/>
    </radialGradient>
    <radialGradient id="pcQ2" cx="35%" cy="30%" r="70%">
      <stop offset="0%" stop-color="#fff1f2"/><stop offset="55%" stop-color="#fca5ad"/><stop offset="100%" stop-color="#e11d48"/>
    </radialGradient>
    <radialGradient id="pcq" cx="35%" cy="30%" r="70%">
      <stop offset="0%" stop-color="#f8fafc"/><stop offset="55%" stop-color="#e2e8f0"/><stop offset="100%" stop-color="#cbd5e1"/>
    </radialGradient>
    <marker id="pcArrowRed" markerWidth="7" markerHeight="7" refX="5.5" refY="3.5" orient="auto"><path d="M0,0.3 L6.6,3.5 L0,6.7 L1.7,3.5 Z" fill="#dc2626"/></marker>
    <marker id="pcArrowPurple" markerWidth="7" markerHeight="7" refX="5.5" refY="3.5" orient="auto"><path d="M0,0.3 L6.6,3.5 L0,6.7 L1.7,3.5 Z" fill="#7c3aed"/></marker>
    <marker id="pcArrowGreen" markerWidth="7" markerHeight="7" refX="5.5" refY="3.5" orient="auto"><path d="M0,0.3 L6.6,3.5 L0,6.7 L1.7,3.5 Z" fill="#16a34a"/></marker>
    <style>
      #pcAnim .pc-s1 { animation: pcFade1 7s ease-in-out infinite; }
      #pcAnim .pc-s2 { animation: pcFade2 7s ease-in-out infinite; }
      #pcAnim .pc-s3 { animation: pcFade3 7s ease-in-out infinite; }
      @keyframes pcFade1 { 0%,4%{opacity:0} 10%,86%{opacity:1} 94%,100%{opacity:0} }
      @keyframes pcFade2 { 0%,34%{opacity:0} 40%,86%{opacity:1} 94%,100%{opacity:0} }
      @keyframes pcFade3 { 0%,64%{opacity:0} 70%,86%{opacity:1} 94%,100%{opacity:0} }
    </style>
  </defs>
  <g id="pcAnim">
    <circle cx="60" cy="50" r="26" fill="url(#pcQ1)"/>
    <text x="60" y="55" text-anchor="middle" font-size="14" font-weight="700" fill="#9f1239">Q&#8321;+</text>

    <circle cx="320" cy="140" r="34" fill="url(#pcQ2)"/>
    <text x="320" y="146" text-anchor="middle" font-size="15" font-weight="700" fill="#fff1f2">Q&#8322;+</text>

    <circle cx="180" cy="170" r="15" fill="url(#pcq)"/>
    <text x="180" y="175" text-anchor="middle" font-size="12" font-weight="700" fill="#475569">q+</text>

    <g class="pc-s1">
      <line x1="180" y1="170" x2="244" y2="234" stroke="#dc2626" stroke-width="3" marker-end="url(#pcArrowRed)"/>
      <text x="250" y="248" font-size="14" fill="#dc2626">F&#8321;</text>
      <line x1="180" y1="170" x2="92" y2="189" stroke="#7c3aed" stroke-width="3" marker-end="url(#pcArrowPurple)"/>
      <text x="58" y="200" font-size="14" fill="#7c3aed">F&#8322;</text>
    </g>

    <g class="pc-s2">
      <line x1="244" y1="234" x2="156" y2="253" stroke="#7c3aed" stroke-width="2" stroke-dasharray="5 4"/>
      <line x1="92" y1="189" x2="156" y2="253" stroke="#dc2626" stroke-width="2" stroke-dasharray="5 4"/>
    </g>

    <g class="pc-s3">
      <line x1="180" y1="170" x2="156" y2="253" stroke="#16a34a" stroke-width="3.5" marker-end="url(#pcArrowGreen)"/>
      <text x="118" y="266" font-size="15" font-weight="600" fill="#16a34a">F&#8348;&#8340;&#8348;</text>
    </g>
  </g>
</svg>
<figcaption><span class="fig-num" data-fig-id="somma-forze-elettriche">Figura</span> — Animazione in loop: prima compaiono le singole forze repulsive $\vec F_1$ e $\vec F_2$ (dirette lontano da $Q_1$ e da $Q_2$), poi le linee tratteggiate che completano il parallelogramma, infine la forza totale $\vec F_{tot}$.</figcaption>
</div>
