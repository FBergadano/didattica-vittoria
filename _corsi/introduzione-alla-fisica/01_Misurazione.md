...
{% include box-imp.html testo="Regola per somma e sottrazione" %}
...
{% include box-imp.html testo="Regola per la moltiplicazione" %}
...
{% include box-imp.html testo="Regola per la divisione" %}
